...
src/card_api/
  ...
  cache.py      # le disque, et son seul propriétaire : chemins, âge des
                ...
                #   périmée) et la dernière LECTURE, tenue par le
                #   registre data/cache.db (table lectures : clé, dernier
                #   accès, nombre d'accès), que l'éviction attend. La
                #   seconde ne
                ...
                #   aveugle. SQLite plutôt qu'un témoin par entrée,
                #   arbitré sur la PÉRENNITÉ le 2026-09-18 : un fichier ne
                #   porte qu'un fait, et le journal d'usage n'enregistre
                #   que le NOMBRE de stations d'une requête, donc le
                #   nombre d'accès PAR entrée ne se dérivait de rien.
                #   Jamais un registre JSON : coordination d'un magasin
